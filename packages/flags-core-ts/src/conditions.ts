 ...
 */
function getAttributeValue(context: Context, attribute: string): unknown {
 ...
 * ```
 */
export function evaluateCondition(condition: Condition, context: Context): boolean {
  ...
  switch (operator) {
    ...
    case 'gt': {
      ...
      if (numActual === null || numValue === null) return false;
 ...
 */
export function evaluateConditions(conditions: Condition[], context: Context): boolean {
